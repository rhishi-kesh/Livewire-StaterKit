    ...
    <div class="h-full bg-white dark:bg-slate-900">
        <div class="flex items-center justify-between px-4 py-3">
            <a href="{{ route('dashboard') }}" class="main-logo flex shrink-0 items-center">
                <img class="ml-[5px] flex-none" width="150" src="{{ asset('dashboard/images/Logo/logo.png') }}"
                    alt="image" />
            </a>
            <a href="javascript:;"
            ...
            <li class="menu nav-item group">
                <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'pages' }"
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="text-black pl-3 dark:text-[#506690] dark:group-hover:text-white-dark">Item</span>
                    </div>
                    <div :class="{ '!rotate-90': activeDropdown === 'pages' }">
