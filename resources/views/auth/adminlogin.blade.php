...
<html lang="en" dir="ltr">
 <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{ asset('dashboard/images/RICT/fav.jpg') }}" />
        <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;500;600;700;800&amp;display=swap" rel="stylesheet" />
        <link defer rel="stylesheet" type="text/css" media="screen" href="{{ asset('dashboard/css/style.css') }}" />
        @vite('resources/css/app.css')
    </head>
    <body class="font-nunito bg-blue-500 w-screen h-screen flex items-center justify-center">
        <div class="w-full">
            <h2 class="text-center mb-5 text-white text-4xl lg:text-7xl">Wellcome Admin</h2>
